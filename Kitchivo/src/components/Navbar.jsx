        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-10 text-xs sm:text-sm">
            ...
            <div className="flex items-center gap-3 sm:gap-6 text-gray-600">
              <a href="tel:+390235568493" className="flex items-center gap-1 sm:gap-2 hover:text-lima-600">
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>+91 0123456789</span>
              </a>
              <a href="mailto:demo@demo.com" className="flex items-center gap-1 sm:gap-2 hover:text-lima-600">
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <div className="flex items-center gap-2 sm:gap-3">
                <a href="#" className="text-gray-600 hover:text-lima-600"><svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg></a>
                <a href="#" className="text-gray-600 hover:text-lima-600"><svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg></a>
                <a href="#" className="text-gray-600 hover:text-lima-600"><svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>
                <a href="#" className="text-gray-600 hover:text-lima-600"><svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121L8.08 13.768l-2.907-.907c-.632-.196-.643-.632.132-.936l11.37-4.38c.526-.196.985.126.816.936z"/></svg></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
              ...
              <button className="relative text-gray-800 hover:text-lima-600 active:text-lima-700 transition-colors">
                ...
                <span className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 bg-lima-600 text-white text-xs rounded-full w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center">0</span>
              </button>
          ...
          <div className="flex items-start justify-center min-h-screen pt-8 sm:pt-16 md:pt-20 p-4">
            <div className="bg-white w-full max-w-[1400px] rounded-xl sm:rounded-2xl shadow-2xl transform transition-all duration-300">
              ...
              <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">Search Products</h3>
                <button 
              ...
              <div className="px-4 sm:px-6 pb-4 sm:pb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <button className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-100 hover:bg-lima-100 active:bg-lima-200 text-gray-700 hover:text-lima-700 rounded-full text-xs sm:text-sm transition-colors">Kitchen Tools</button>
                  <button className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-100 hover:bg-lima-100 active:bg-lima-200 text-gray-700 hover:text-lima-700 rounded-full text-xs sm:text-sm transition-colors">Cookware</button>
                  <button className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-100 hover:bg-lima-100 active:bg-lima-200 text-gray-700 hover:text-lima-700 rounded-full text-xs sm:text-sm transition-colors">Storage</button>
                  <button className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-100 hover:bg-lima-100 active:bg-lima-200 text-gray-700 hover:text-lima-700 rounded-full text-xs sm:text-sm transition-colors">Home Decor</button>
                  <button className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-100 hover:bg-lima-100 active:bg-lima-200 text-gray-700 hover:text-lima-700 rounded-full text-xs sm:text-sm transition-colors">Dining Sets</button>
                </div>
              </div>
            </div>
          </div>
