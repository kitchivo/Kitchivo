      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative px-0 sm:px-8 md:px-12">
          ...
          <button
            ...
            w-10 h-10 md:w-12 md:h-12 bg-white rounded-full shadow-lg items-center justify-center 
            hover:bg-lima-600 hover:text-white active:bg-lima-700 transition-all duration-300"
            aria-label="Previous"
          >
